...
exec(open(os.path.join('sdscheduler', 'version.py')).read())  # set __version__
...
setup(
    name=PACKAGE,
    version=__version__,
    description='sdscheduler: A cron-replacement library from Nextdoor',
    long_description=open('README.md').read(),
    author='Nextdoor Engineering',
    author_email='eng@nextdoor.com',
    url='https://github.com/Nextdoor/sdscheduler',
    download_url='http://pypi.python.org/pypi/sdscheduler#downloads',
