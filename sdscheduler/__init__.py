...
SDSCHEDULER_SETTINGS_MODULE environment variable.

Any machine that wants to run a scheduler powered by sdscheduler MUST have
SDSCHEDULER_SETTINGS_MODULE as an environment variable or this module
...
from sdscheduler import default_settings
...
ENVIRONMENT_VARIABLE = 'SDSCHEDULER_SETTINGS_MODULE'
...
def setup_package():
    ...
    os.environ[ENVIRONMENT_VARIABLE] = 'sdscheduler.default_settings_test'
...
class Settings(object):
    """Singleton class to manage sdscheduler settings."""
