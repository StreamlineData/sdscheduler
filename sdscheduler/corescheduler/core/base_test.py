...
from sdscheduler.corescheduler.core.base import BaseScheduler
...
class BaseSchedulerTest(unittest.TestCase):
    ...
    def test_is_okay_to_run(self):
        with mock.patch(('sdscheduler.corescheduler.core.base.'
            ...
            dcp = 'sdscheduler.corescheduler.datastore.providers.sqlite.DatastoreSqlite'
