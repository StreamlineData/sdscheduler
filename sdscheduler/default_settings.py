...
# See different database providers in sdscheduler/core/datastore/providers/

# SQLite
#
DATABASE_CLASS = 'sdscheduler.corescheduler.datastore.providers.sqlite.DatastoreSqlite'
...
# Postgres
#
# DATABASE_CLASS = 'sdscheduler.corescheduler.datastore.providers.postgres.DatastorePostgres'
# DATABASE_CONFIG_DICT = {
#     'user': 'username',
#     'password': '',
#     'hostname': 'localhost',
...
# MySQL
#
# DATABASE_CLASS = 'sdscheduler.corescheduler.datastore.providers.mysql.DatastoreMySQL'
# DATABASE_CONFIG_DICT = {
#     'user': 'username',
#     'password': '',
#     'hostname': 'localhost',
...
# Please see sdscheduler/core/scheduler/base.py
